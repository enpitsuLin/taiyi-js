import Convert from '../packages/serializer/src/convert';
import { Long } from 'bytebuffer';

import assert from 'assert';
import { default as type } from '../packages/serializer/src/types';
import p from '../packages/serializer/src/precision';
import th from './test_helper';

describe("taiyi.auth: types", function () {
    ...
    it("public_key sort", function () {
        ...
        let map = mapType.fromObject([//not sorted
            ["TAI8me6d9PqzTgcoHxx6b4rnvWVTqz11kafidRAZwfacJkcJtfd75", 0],
            ["TAI56ankGHKf6qUsQe7vPsXTSEqST6Dt1ff73aV3YQbedzRua8NLQ", 0],
        ])
