...
import Serilizer from "serializer/src/serializer"
import types from "serializer/src/types";
import ops from "serializer/src/operations";
...
let allTypes = {
    ...
    static_variant: [
        ["transfer", { from: "alice", to: "bob", amount: "1.000 YANG", memo: "" }],
        ["price", { base: "1.000 YANG", quote: "1.000 YANG" }],
    ],
